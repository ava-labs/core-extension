...
test.describe('Contacts', () => {
  test(
    'As a CORE ext user, when I have no contacts I see an empty state',
    {
      ...
      annotation: [
        ...
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-001' },
      ],
    },
  ...
  test(
    'As a CORE ext user, I can add a new contact',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-002' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can see Avalanche CXP Chain, BTC, and Solana addresses for contacts',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-003' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can copy an address from the contact details',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-004' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can edit an existing contact',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-005' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can search for a contact',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-006' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, when I search for a non existent contact I see No contacts match your search state',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-007' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can delete a contact',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-008' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
  ...
  test(
    'As a CORE ext user, I can delete one contact when multiple contacts exist',
    {
      ...
      annotation: [
        { type: 'snapshot', description: 'mainnetPrimaryExtWallet' },
        { type: 'testrail_case_field', description: 'custom_automation_id:EXT-CONTACTS-009' },
      ],
    },
    async ({ unlockedExtensionPage }) => {
      const contactsPage = new ContactsPage(unlockedExtensionPage);
