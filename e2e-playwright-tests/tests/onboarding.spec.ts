...
test.describe('Onboarding', () => {
  test(
    ...
    {
      tag: '@smoke',
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_001' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      tag: '@smoke',
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_002' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      tag: '@smoke',
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_003' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      tag: '@smoke',
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_004' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      tag: '@smoke',
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_005' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_006' }],
    },
    async ({ extensionPage }) => {
  ...
  test(
    ...
    {
      annotation: [{ type: 'testrail_case_field', description: 'custom_automation_id:EXT_ONBOARDING_008' }],
    },
    async ({ extensionPage }) => {
