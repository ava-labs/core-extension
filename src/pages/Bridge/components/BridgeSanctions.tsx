  ...
  return (
    <VerticalFlex>
      ...
      <Typography size={16} align="center" height="24px" margin="0 16px">
        Users may not use the Bridge if they are on the Specially Designated
        Nationals (SDN) List of the Office of Foreign Assets Control (OFAC) or
        any other sanctions list or are otherwise a sanctioned person or from a
