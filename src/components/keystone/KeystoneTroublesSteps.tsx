...
export enum KeystoneTroubleStepsFontVariant {
  small = 'body1',
  large = 'body2',
}

export function KeystoneTroubleSteps({
  fontVariant = KeystoneTroubleStepsFontVariant.small,
  sx = {},
}: {
  fontVariant?: KeystoneTroubleStepsFontVariant;
  sx?: SxProps;
}) {
