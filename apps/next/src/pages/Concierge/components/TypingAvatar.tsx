import { getHexAlpha, keyframes, styled, useTheme } from '@avalabs/k2-alpine';
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1}
      />
      <circle cx="18" cy="25" r="2" fill={dotFill} className="first" />
      <circle cx="24" cy="21" r="2" fill={dotFill} className="second" />
      <circle cx="30" cy="25" r="2" fill={dotFill} className="third" />
    </TypingAnimation>
  );
};
