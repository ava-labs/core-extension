...
export const UNRESTRICTED_METHODS = Object.freeze([
  ...
  RpcMethod.AVALANCHE_DECLARE_AGENT_IDENTITY,
]);
...
const CORE_METHODS = Object.freeze([
  ...
  DAppProviderRequest.WALLET_NOTIFY_NOTIFICATION_CENTER_CHANGED,
  DAppProviderRequest.WALLET_GET_NOTIFICATION_DEVICE_ARN,
