import { NetworkService } from 'packages/service-worker/src/services/network/NetworkService';
import { ActiveNetworkMiddleware } from './ActiveNetworkMiddleware';
import { RpcMethod } from '@avalabs/vm-module-types';
import getTargetNetworkForTx from 'packages/service-worker/src/services/wallet/utils/getTargetNetworkForTx';
